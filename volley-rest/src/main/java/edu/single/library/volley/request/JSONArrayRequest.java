...
public class JSONArrayRequest extends JSONRequest<JSONArray> {
    ...
    private final CallBackListener<JSONArray> callBackListener;
    private final boolean cacheEnable;

    public JSONArrayRequest(final String url, final RequestParams urlParams, final CallBackListener<JSONArray> callBackListener) {
                ...
                if (callBackListener != null) {
                    if ((error.getCause() instanceof HttpHostConnectException) && urlParams != null && urlParams.getCacheEnable()) {
                        ...
                        if (EmptyUtils.emptyOfString(json)) {
                            ...
                            try {
                                callBackListener.onResponse(new JSONArray(json));

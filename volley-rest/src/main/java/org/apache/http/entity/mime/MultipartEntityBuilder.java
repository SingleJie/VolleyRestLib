...
public class MultipartEntityBuilder implements OnUploadListener {
    ...
    public void setUploadListener(OnUploadListener mListener) {
    ...
    MultipartFormEntity buildEntity() {
        ...
        totalLength = form.getTotalLength();

        return new MultipartFormEntity(form, generateContentType(b, cs), totalLength, this);
    }
    ...
    public void onUploadCallBack(long current, long totalLength) {
        ...
        if (mListener != null) {
            mListener.onUploadCallBack(uploadCurrent, this.totalLength);
        }
    }
